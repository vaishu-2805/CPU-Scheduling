# Function to calculate waiting time for Priority Scheduling (Non-Preemptive)
def priority_non_preemptive(processes, arrivalTime, burstTime, priority):
    ...
    while completedCount < n:
        # Find the process with the highest priority (lower value = higher priority)
        idx = -1
...
def calculateAverageTimes(processes, arrivalTime, burstTime, priority):
    ...
    waitingTime = priority_non_preemptive(sorted_processes, sorted_arrivalTime, sorted_burstTime, sorted_priority)
